...
let handler = async (m, { conn, command, text }) => {
  ...
  let pp = await conn.profilePictureUrl(who, 'image').catch((_) => "https://telegra.ph/file/e52eb5f3c4f2f983600d8.jpg")
...
contextInfo: { externalAdReply :{
                        mediaUrl: 'https://tiktok.com/@yann.4ever',
                        mediaType: 2,
                        description: 'anu',
                        title: global.titlebot,
                        body: '⚘ ᴄʀᴇᴀᴛᴇ ʙʏ yan prtm',          previewType: 0,
